    ...
    <div class="container" style="display: flex; flex-direction: column; align-items: center; gap: 2rem">
        ...
        <form action="Actualizar" method="post">
            ...
            <div class="mb-3">
                ...
                <input required type="text" id="titol" name="titol" class="form-control" value="<%= request.getAttribute("titol") != null ? request.getAttribute("titol") : "" %>">
            </div>
            <div class="mb-3">
                <label for="isbn" class="form-label">ISBN</label>
                <input required type="text" id="isbn" name="isbn" class="form-control" value="<%= request.getAttribute("isbn") != null ? request.getAttribute("isbn") : "" %>">
            </div>
            <div class="mb-3">
                <label for="any_publicacio" class="form-label">Año de Publicación</label>
                <input required type="number" id="any_publicacio" name="any_publicacio" class="form-control" value="<%= request.getAttribute("anyPublicacio") != null ? request.getAttribute("anyPublicacio") : "" %>">
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn-custom">Aceptar</button>
        </form>
    </div>
